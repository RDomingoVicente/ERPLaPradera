...
class __TwigTemplate_e0067aef7486a2e40bdb7321d7176384 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 41
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_0 = $context["includeView"]) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["path"] ?? null) : null), "Master/MenuBgTemplate.html.twig", 41)->unwrap()->yield($context);
            // line 42
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["includeView"]) {
            // line 44
            yield "        ";
            yield from             $this->loadTemplate((($__internal_compile_1 = $context["includeView"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["path"] ?? null) : null), "Master/MenuBgTemplate.html.twig", 44)->unwrap()->yield($context);
            // line 45
            yield "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
{% endblock %}", "Master/MenuBgTemplate.html.twig", "/var/www/html/Core/View/Master/MenuBgTemplate.html.twig");
    }
}
