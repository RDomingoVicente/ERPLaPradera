...
/**
 * Clase para generar el JSON de inicio del modo No-Verifactu.
 *
 * @author Daniel Fernández Giménez <hola@danielfg.es>
 */
final class JsonInicioNoVerifactu
{
    use JsonTrait;
    use JsonRegistroEventoTrait;

    const FILE_NAME = 'inicio-no-verifactu';
    ...
    {
        self::$json['Evento']['TipoEvento'] = '01';
        return true;
    }
}